...
<head>
    ...
    <style>
      ...
      .avatar-selection-dropdown .avatar-menu {
        position: absolute;
        top: 100%;
        right: 0;
        background: rgba(255, 255, 255, 0.95);
      ...
      .avatar-selection-dropdown .avatar-menu.show {
        display: block;
      }
          ...
          <div class="avatar-container h-100">
            ...
            <div class="avatar-overlay">
              ...
              <div class="avatar-controls">
                <button id="customize-avatar-btn" class="btn btn-sm btn-outline-light">
                  <i class="fa fa-user"></i> Customize Avatar
                </button>
                
                <div class="avatar-selection-dropdown">
                  <button id="avatar-toggle" class="btn btn-sm btn-outline-light">
                    <i class="fa fa-users"></i> <span id="current-avatar-name">Female Avatar</span>
                    <i class="fa fa-chevron-down" style="margin-left: 5px; font-size: 0.7rem;"></i>
                  </button>
                  <div class="avatar-menu" id="avatar-selection-menu">
                    <div class="avatar-menu-item active" data-avatar="female">
                      <i class="fa fa-female"></i>
                      <span>Female Avatar</span>
                      <i class="fa fa-check avatar-checkmark"></i>
                    </div>
                    <div class="avatar-menu-item" data-avatar="male">
                ...
                <button id="revert-avatar-btn" class="btn btn-sm btn-outline-light">
                  <i class="fa fa-undo"></i> Reset to Default
                </button>
                
                <button id="force-male-animations-btn" class="btn btn-sm btn-outline-light" style="display: none;">
  ...
  <script>
    ...
    function setupEventListeners() {
      ...
      try {
        ...
        const revertAvatarBtn = document.getElementById('revert-avatar-btn');
        if (revertAvatarBtn) {
          revertAvatarBtn.addEventListener('click', function() {
            revertToOriginalAvatar();
          });
          console.log('✅ Revert avatar button listener added');
        } else {
          console.warn('⚠️ Revert avatar button not found');
        }
      
      // Force male animations (for when detection is wrong)
      document.getElementById('force-male-animations-btn').addEventListener('click', function() {
        forceMaleAnimations();
      });
      ...
      avatarToggle.addEventListener('click', function(e) {
        e.stopPropagation();
        avatarSelectionMenu.classList.toggle('show');
      });
      
      // Close avatar dropdown when clicking outside
      document.addEventListener('click', function() {
        avatarSelectionMenu.classList.remove('show');
      });
      
      // Prevent dropdown from closing when clicking inside
      avatarSelectionMenu.addEventListener('click', function(e) {
        e.stopPropagation();
      });
    ...
    function switchAvatar(avatarType) {
      ...
      // Update UI
      document.getElementById('current-avatar-name').textContent = selectedAvatar.name;
      
      // Update active avatar in menu
      document.querySelectorAll('#avatar-selection-menu .avatar-menu-item').forEach(item => {
      ...
      // Close dropdown
      document.getElementById('avatar-selection-menu').classList.remove('show');
    ...
    function revertToOriginalAvatar() {
      ...
      document.querySelector('[data-avatar="female"]').classList.add('active');
